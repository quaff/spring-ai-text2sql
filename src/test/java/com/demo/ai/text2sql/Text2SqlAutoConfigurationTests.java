...
class Text2SqlAutoConfigurationTests {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(Text2SqlAutoConfiguration.class,
                    DataSourceAutoConfiguration.class, JdbcTemplateAutoConfiguration.class, JdbcClientAutoConfiguration.class,
    ...
    void shouldCreateLoggingCustomizerWhenLoggingEnabled() {
        contextRunner
                .withPropertyValues("text2sql.logging=true")
                .run(context -> {
    ...
    void shouldNotCreateLoggingCustomizerWhenLoggingDisabled() {
        contextRunner
                .withPropertyValues("text2sql.logging=false")
                .run(context -> {
