...
public class DatabaseInformationAdvisor implements BaseAdvisor {
	...
	public ChatClientRequest before(ChatClientRequest chatClientRequest, AdvisorChain advisorChain) {
		...
		template.add("databaseProductName", this.databaseInformation.getDatabaseProductName());
		template.add("databaseVersion", this.databaseInformation.getDatabaseVersion());
